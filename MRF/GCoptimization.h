...
protected:
    ...
    LabelType *m_labeling_fm_1;
    LabelType *m_labeling_fm_2;
...
/*<==========================================================================================================>*/
    void add_t_links_ARRAY_qpbo(QPBO<REAL> *q,int size);
    void add_t_links_FnPix_qpbo(QPBO<REAL> *q,int size);        
/*<==========================================================================================================>*/
/*<==================== QPBO implementation for fusion moves (Two Labelings) ================================>*/
/*<==================================== MILAN JAIN & ANIL SHARMA ============================================>*/
/*<==========================================================================================================>*/
...
class Fusion: public Expansion
{
public:
    Fusion(PixelType width,PixelType height,int num_labels,EnergyFunction *eng):Expansion(width,height,num_labels,eng){};
    Fusion(PixelType nPixels, int num_labels,EnergyFunction *eng):Expansion(nPixels,num_labels,eng){};


    /* Peforms expansion algorithm. Runs the number of iterations specified by max_num_iterations */
    /* Returns the total energy of labeling   */
    EnergyType fusion(int max_num_iterations);
...
private:
    EnergyType start_fusion(int max_iterations);

    void set_up_fusion_energy_G_ARRAY_VW_qpbo(int size, QPBO<REAL>* q);
    void set_up_fusion_energy_G_ARRAY_qpbo(int size, QPBO<REAL>* q);
    void set_up_fusion_energy_G_FnPix_qpbo(int size, QPBO<REAL>* q);
    void set_up_fusion_energy_NG_ARRAY_qpbo(int size, QPBO<REAL>* q);
    void set_up_fusion_energy_NG_FnPix_qpbo(int size, QPBO<REAL>* q);

    void perform_fusion_move_qpbo();  
};
